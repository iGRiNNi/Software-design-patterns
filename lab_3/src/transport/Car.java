...
////        return false;
    ...
    public void setPrintCommand(PrintCommand printCommand) {
        if (printCommand == null) {
            throw new IllegalArgumentException("PrintCommand cannot be null");
        }
    ...
    public void print(OutputStream outputStream) throws IOException {
        if (printCommand == null) {
            throw new IllegalStateException("PrintCommand is not set");
        }

        printCommand.print(this, outputStream);
    }
